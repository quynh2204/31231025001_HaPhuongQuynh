...
{
    /// <inheritdoc />
    public partial class Social_Network_Migration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePicture = table.Column<byte[]>(type: "BLOB", maxLength: 1048576, nullable: false),
                    RegisteredOn = table.Column<DateTime>(type: "TEXT", nullable: false),
                    LastTimeLoggedIn = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumUsers", x => new { x.AlbumId, x.UserId });
                    table.ForeignKey(
